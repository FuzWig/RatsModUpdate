...
public class RenderRat extends MobRenderer<EntityRat, SegmentedModel<EntityRat>> {
    ...
    private static final ResourceLocation DRUID_UPGRADE_TEXTURE = new ResourceLocation("rats:textures/entity/rat/rat_druid_upgrade.png");
    ...
    private static final ResourceLocation BOB = new ResourceLocation("rats:textures/entity/rat/patreon/rat_bob.png");
    private static final ResourceLocation SCHWEE = new ResourceLocation("rats:textures/entity/rat/patreon/rat_schwee.png");
	private static final ResourceLocation BOINED = new ResourceLocation("rats:textures/entity/rat/patreon/rat_boined.png");
	private static final ResourceLocation HAIRLESS = new ResourceLocation("rats:textures/entity/rat/patreon/rat_hairless.png");
    private static final ResourceLocation LLED = new ResourceLocation("rats:textures/entity/rat/patreon/rat_lled.png");
    private static final ResourceLocation DIANE = new ResourceLocation("rats:textures/entity/rat/patreon/rat_diane.png");
    private static final ResourceLocation HAPPY = new ResourceLocation("rats:textures/entity/rat/patreon/rat_happy.png");
    private static final ResourceLocation WITCH = new ResourceLocation("rats:textures/entity/rat/patreon/rat_witch.png");
    ...
    public ResourceLocation getEntityTexture(EntityRat entity) {
        ...
        if (entity.isChild()) {
            ...
            if (entity.hasUpgrade(RatsItemRegistry.RAT_UPGRADE_DRUID)) {
                return DRUID_UPGRADE_TEXTURE;
            }
            ...
            if (entity.hasCustomName()) {
                ...
                if (str.contains("bob") || str.contains("Bob")) {
                    return BOB;
                }
                if (str.contains("schwee") || str.contains("Schwee")|| str.contains("Oatly")|| str.contains("oatly")) {
                    return SCHWEE;
                }
				if (str.contains("boined") || str.contains("Boined")|| str.contains("Bean")|| str.contains("bean")) {
                    return BOINED;
                }
				if (str.contains("hairless") || str.contains("Hairless")) {
                    return HAIRLESS;
                }
                if (str.contains("lled") || str.contains("LLed")) {
                    return LLED;
                }
                if (str.contains("diane") || str.contains("Diane")) {
                    return DIANE;
                }
                if (str.contains("happy") || str.contains("Happy")) {
                    return HAPPY;
                }
                if (str.contains("witch") || str.contains("Witch")|| str.contains("Druid")|| str.contains("druid")) {
                    return WITCH;
                }
            }
